      ...
      <header className="lg:hidden fixed top-0 left-0 right-0 z-50 bg-white border-b px-4 py-3 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <Link href="/" className="flex items-center gap-2">
            ...
            <span className="font-bold">OMIS Tech</span>
          </Link>
        </div>
        <div className="flex items-center gap-2">
          ...
          <Avatar className="h-8 w-8">
            <AvatarImage src="/avatars/technician.jpg" />
        ...
        <div className="p-4 border-t border-slate-700">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-slate-400 truncate">Master Electrician</p>
            </div>
          </div>
          <div className="flex gap-2">
            <Link href="/technician/profile" className="flex-1">
